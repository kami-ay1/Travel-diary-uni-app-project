<template>
	<view class='line'>
		<view class='mapBox'>
			<map v-if='detailInfo.id' style="width: 100%;height: 900rpx;" :latitude="detailInfo.location[0]" :longitude="detailInfo.location[1]" 
			:show-scale="true" :markers="detailInfo.markers"></map>
		</view>
		<view class='infos'>
			<view class='tit'>
